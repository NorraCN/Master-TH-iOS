...
+ (NSString *)weekdayForVaccineDetails:(NSDate *)date{
...
- (NSString *)stringYearMonthDayForVaccineDetails{
    return [NSDate stringYearMonthDayForVaccineDetailsWithDate:self];
}
...
- (NSString *)stringYearMonthDayHourMinuteSecondNoConnector{
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
...
- (NSString *)stringMonthDayMinuteSecond {
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
...
+ (NSString *)stringYearMonthDayForVaccineDetailsWithDate:(NSDate *)date{
