...
- (NSString *)stringYearMonthDayHourMinuteSecondNoConnector; // 中间没有连接符
+ (NSString *)stringYearMonthDayWithDate:(NSDate *)date;      //date为空时返回的是当前年月日
+ (NSString *)stringLoacalDate;
- (NSString *)stringMonthDayMinuteSecond; // 03-02 14:19
...
+ (NSString *)weekdayForVaccineDetails:(NSDate *)date; // 疫苗详情页显示为周几
